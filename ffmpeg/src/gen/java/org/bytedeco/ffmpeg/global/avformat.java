 ...
 * avio_print.
 */
@NoException public static native void avio_print_string_array(AVIOContext s, @Cast("const char*const*") PointerPointer strings);
@NoException public static native void avio_print_string_array(AVIOContext s, @Cast("const char*const*") @ByPtrPtr BytePointer strings);
@NoException public static native void avio_print_string_array(AVIOContext s, @Cast("const char*const*") @ByPtrPtr ByteBuffer strings);
@NoException public static native void avio_print_string_array(AVIOContext s, @Cast("const char*const*") @ByPtrPtr byte[] strings);
...
// Targeting ../avformat/AVIAMFMixPresentation.java


// Targeting ../avformat/AVStreamGroup.java
 ...
 */
@NoException public static native @Cast("AVDurationEstimationMethod") @Deprecated int av_fmt_ctx_get_duration_estimation_method(@Const AVFormatContext ctx);
// #endif
 ...
 * @see av_opt_find().
 */
@NoException public static native @Const AVClass av_stream_group_get_class();

/**
 * @return a string identifying the stream group type, or NULL if unknown
 */
@NoException public static native @Cast("const char*") BytePointer avformat_stream_group_name(@Cast("AVStreamGroupParamsType") int type);
 ...
 */
@NoException public static native AVStreamGroup avformat_stream_group_create(AVFormatContext s,
                                            @Cast("AVStreamGroupParamsType") int type,
                                            @Cast("AVDictionary**") PointerPointer options);
@NoException public static native AVStreamGroup avformat_stream_group_create(AVFormatContext s,
                                            @Cast("AVStreamGroupParamsType") int type,
                                            @ByPtrPtr AVDictionary options);
 ...
 */
@NoException public static native int avformat_stream_group_add_stream(AVStreamGroup stg, AVStream st);
...
public static final int LIBAVFORMAT_VERSION_MAJOR =  61;
 ...
 *
 */
public static final boolean FF_API_COMPUTE_PKT_FIELDS2 =      (LIBAVFORMAT_VERSION_MAJOR < 62);
public static final boolean FF_API_LAVF_SHORTEST =            (LIBAVFORMAT_VERSION_MAJOR < 62);
public static final boolean FF_API_ALLOW_FLUSH =              (LIBAVFORMAT_VERSION_MAJOR < 62);
