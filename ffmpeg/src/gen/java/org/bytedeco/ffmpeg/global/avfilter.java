 ...
 */
@NoException public static native @Deprecated void avfilter_link_free(@Cast("AVFilterLink**") PointerPointer link);
@NoException public static native @Deprecated void avfilter_link_free(@ByPtrPtr AVFilterLink link);

/**
 * @deprecated this function should never be called by users
 */
@NoException public static native @Deprecated int avfilter_config_links(AVFilterContext filter);
// #endif
...
@NoException public static native @Cast("AVColorSpace") int av_buffersink_get_colorspace(@Const AVFilterContext ctx);
@NoException public static native @Cast("AVColorRange") int av_buffersink_get_color_range(@Const AVFilterContext ctx);
...
public static final int LIBAVFILTER_VERSION_MAJOR =  10;
...
public static final boolean FF_API_LINK_PUBLIC =     (LIBAVFILTER_VERSION_MAJOR < 11);
